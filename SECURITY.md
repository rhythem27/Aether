...
| Version | Supported |
| :--- | :--- |
| `0.1.x` (Main / Head) | :white_check_mark: Supported |
| `< 0.1.0` | :x: End of Life |
...
2. Send an email to **security@aether.ai** with the subject `[SECURITY VULNERABILITY] <Brief Description>`.
3. Include the following details in your email:
   * Description of the vulnerability and potential impact.
   * Proof of Concept (PoC) or step-by-step instructions to reproduce.
   * Component affected (`api`, `mcp-server`, `qdrant`, `neo4j`, etc.).
