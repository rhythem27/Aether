...
@mcp.tool()
async def get_recent_news(query: str, timeframe: str = "7d", limit: int = 5) -> List[Dict[str, Any]]:
...
async def analyze_news_sentiment(articles: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    if not articles:
        return {"aggregate_score": 0.0, "sentiment": "NEUTRAL", "positive_count": 0, "negative_count": 0, "risk_keywords": []}

    pos_keywords = {"strong", "growth", "expansion", "bullish", "profit", "surpass", "buy"}
    neg_keywords = {"risk", "scrutiny", "lawsuit", "decline", "investigation", "loss", "bearish"}
