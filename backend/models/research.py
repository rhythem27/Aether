...
class ResearchRequest(BaseModel):
    ...
    target_company: str = Field(
        ..., description="Company ticker or full name (e.g. AAPL, NVDA)"
    )
    research_depth: Literal["quick", "standard", "deep"] = Field(
        default="standard", description="Investigation depth level"
    )
    ...
    output_format: Literal["json", "markdown", "pdf"] = Field(
