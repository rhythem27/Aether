...
class EmbeddingService:
    ...
    def _get_sentence_transformer(self):
        ...
        if self._st_model is None:
            try:
                ...
                self._st_model = SentenceTransformer("BAAI/bge-large-en-v1.5", local_files_only=True)
    ...
    async def embed_documents(self, texts: List[str], input_type: str = "search_document") -> List[List[float]]:
